...
Fixed test lessons are intentionally skipped because assessment content should
remain controlled by the application rather than generated by AI.
...
def main() -> None:
    ...
    try:
        ...
        for lesson in lessons:
            if lesson.is_test:
                skipped_count += 1
                logger.info("SKIP lesson_id=%s fixed test lesson", lesson.id)
                continue
