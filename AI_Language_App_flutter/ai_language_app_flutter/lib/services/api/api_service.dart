...
class ApiService {
  ...
  Future<Map<String, dynamic>> updateLearningProfile({required String language, required String level, required double progress}) =>
      _learning.updateLearningProfile(language: language, level: level, progress: progress);
  ...
  // Words
  Future<Map<String, dynamic>> createWord({required String word, required String translation}) =>
      _words.createWord(word: word, translation: translation);
  Future<List<dynamic>> getWords() => _words.getWords();
  Future<Map<String, dynamic>> updateWordStatus({required int wordId, required bool learned}) =>
