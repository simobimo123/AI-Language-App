...
class _LessonJourneyPageState extends State<LessonJourneyPage> {
  ...
  bool _loading = true;
  String? _error;
  String _teachingStatus = 'available';
  ...
  Future<void> _loadStages() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _teachingStatus = readStatus('teaching', 'available');
  ...
  Widget build(BuildContext context) {
    ...
    final completedCount = [_teachingCompleted, _practiceCompleted].where((value) => value).length;
