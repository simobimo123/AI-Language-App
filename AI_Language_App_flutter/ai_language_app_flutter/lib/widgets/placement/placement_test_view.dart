...
class _WordsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        Text(
          text(ar: 'اختبار المفردات', en: 'Vocabulary test'),
        ...
        Wrap(
          ...
          children: controller.words.map((word) {
            ...
            return FilterChip(
              ...
              selected: selected,
              onSelected: (_) => controller.toggleWord(word.id),
              avatar: Icon(
                selected
                    ? Icons.check_rounded
        ...
        SizedBox(
          ...
          child: FilledButton(
            ...
            child: controller.isEvaluating
                ...
                : Text(text(ar: 'متابعة', en: 'Continue')),
          ),
        ),
      ],
    );
...
class _QuizView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        Text(
          text(ar: 'اختبار التأكيد', en: 'Confirmation test'),
          style: theme.textTheme.headlineSmall?.copyWith(
            fontWeight: FontWeight.bold,
          ),
        ),
                ...
                children: [
                  ...
                  ...List.generate(question.choices.length, (index) {
                    return RadioListTile<int>(
                      value: index,
                      groupValue: selected,
                      onChanged: controller.isEvaluating
                          ? null
                          : (value) {
                              if (value != null) {
        ...
        SizedBox(
          ...
          child: FilledButton(
            ...
            child: controller.isEvaluating
                ...
                : Text(text(ar: 'إنهاء الاختبار', en: 'Finish test')),
          ),
        ),
      ],
    );
